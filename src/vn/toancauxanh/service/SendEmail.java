...
import vn.toancauxanh.gg.model.enums.TaiKhoanEmailEnum;
...
public class SendEmail extends BasicService<Object> {
	...
	public static void sendEmailGmail(String mailTo, String subject, String content) {
		...
		final String username = TaiKhoanEmailEnum.TAIKHOAN.getText();
		final String password = TaiKhoanEmailEnum.MATKHAU.getText();
