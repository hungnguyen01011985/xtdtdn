...
//	private boolean validateDate(final ValidationContext ctx) {
//		String dateValue = (String) ctx.getValidatorArg("dateValue");
//		boolean result = true;
//		System.out.println("vo 111");
//		if (dateValue != null) {
//			String date = (String) ctx.getProperty().getValue();
//			if (date != null && !date.isEmpty() && date.trim().matches("^(?:(?:31(\\/|-|\\.)(?:0?[13578]|1[02]))\\1|(?:(?:29|30)(\\/|-|\\.)(?:0?[1,3-9]|1[0-2])\\2))(?:(?:1[6-9]|[2-9]\\d)?\\d{2})$|^(?:29(\\/|-|\\.)0?2\\3(?:(?:(?:1[6-9]|[2-9]\\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\\d|2[0-8])(\\/|-|\\.)(?:(?:0?[1-9])|(?:1[0-2]))\\4(?:(?:1[6-9]|[2-9]\\d)?\\d{2})$")) {
//				result = true;
//				System.out.println("vo 222");
//			} else {
//				addInvalidMessage(ctx, "Ngày nhập vào không đúng định dạng.");
//				System.out.println("vo 333");
//				result = false;
//			}
//		}
//		return result;
